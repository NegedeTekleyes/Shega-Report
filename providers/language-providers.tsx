...
export const translations = {
  ...
  photoAccessRequired: { en: 'Please allow access to your photos', am: 'እባክዎ ወደ ፎቶዎች መዳረሻ ይፍቀዱ' },
  imageProcessingFailed: { en: 'Failed to process the selected image', am: 'የተመረጠውን ምስል ማስተናገድ አልተቻለም' },
  imagePickFailed: { en: 'Failed to pick image', am: 'ምስል ማምረጥ አልተቻለም' },
  photoProcessingFailed: { en: 'Failed to process the taken photo', am: 'የተነሳውን ፎቶ ማስተናገድ አልተቻለም' },
  takePhotoFailed: { en: 'Failed to take photo', am: 'ፎቶ ማንሳት አልተቻለም' },
  locationPermissionDenied: { en: 'Location permission denied', am: 'የአካባቢ ፍቃድ ተቀባይነት አላገኘም' },
  ...
  pleaseFillFollowing: { en: 'Please fill the following fields:', am: 'እባክዎ የሚከተሉትን መስኮች ይሙሉ' },
  descriptionTooShort: { en: 'Description too short', am: 'መግለጫ በጣም አጭር ነው' },
  provideMoreDetails: { en: 'Please provide more details about the issue.', am: 'እባክዎ በበለጠ ዝርዝር መግለጫ ይስጡ።' },
  locationMissing: { en: 'Location Missing', am: 'አካባቢ ይጠበቃል' },
  enableLocationServices: { en: 'Please enable location services before submitting.', am: 'እባክዎ በሪፖርት ማስገባት በፊት የአካባቢ አገልግሎትን ያብሩ።' },
  photoError: { en: 'Photo Error', am: 'የፎቶ ስህተት' },
  photoProcessingError: { en: 'The selected photos could not be processed. Please try selecting them again.', am: 'የተመረጡት ፎቶዎች ሊሰሩ አልቻሉም። እባክዎ እንደገና ይምረጡ።' },
  noAccessToken: { en: 'No access token found. Please login again.', am: 'የመዳረሻ ማስመሰያ አልተገኘም። እባክዎ ደግመው ይግቡ።' },
  reportSubmitted: { en: 'Report Submitted', am: 'ሪፖርት ቀርቧል' },
  issueReportedSuccessfully: { en: 'Your issue has been reported successfully!', am: 'ችግርዎ በተሳካ ሁኔታ ተጠቅሷል!' },
  viewMyReports: { en: 'View My Reports', am: 'ሪፖርቶቼን ይመልከቱ' },
  submitReportFailed: { en: 'Failed to submit report', am: 'ሪፖርት ለመላክ አልተቻለም' },
  submitReportError: { en: 'Something went wrong while submitting the report', am: 'ሪፖርት በማስገባት ላይ ስህተት ተፈጥሯል' },
  issueTitle: { en: 'Issue Title', am: 'የችግሩ ርዕስ' },
  issueTitlePlaceholder: { en: 'e.g., Water leak in kitchen', am: 'ለምሳሌ፥ በማዕድን ቤት ውሃ ፍሳሽ' },
  descriptionPlaceholder: { en: 'Describe the issue in detail...', am: 'ችግሩን በዝርዝር ይግለጹ...' },
  locationPlaceholder: { en: 'e.g., Kebele 03, House #25', am: 'ለምሳሌ፥ ቀበሌ ፫፣ ቤት ቁጥር ፳፭' },
