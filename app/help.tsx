    ...
    en: [
      {
        ...
        answer:
          "Go to the Report tab, fill in the details about the issue, add photos if available, and submit. Our team will review it promptly.",
      },
      {
        question: "How long does it take to resolve issues?",
        answer:
          "Response time varies based on issue severity. Emergency issues are prioritized and typically addressed within 24 hours.",
      },
      {
        question: "Can I track my reported issues?",
        answer:
          "Yes, you can view all your submitted reports and their status in the Reports section of your profile.",
      },
      {
        question: "Is the service free to use?",
        answer:
          "Yes, ShegaReport is completely free for residents of Debre Birhan to report water and sanitation issues.",
      },
    ],
    am: [
      {
        ...
        answer:
          "ወደ ሪፖርት ትር ይሂዱ፣ ስለ ችግሩ ዝርዝሮችን ይሙሉ፣ ፎቶዎች ካሉዎት ያክሉ እና ያስገቡ። ቡድናችን በተጠናከረ ሁኔታ ይገመግመዋል።",
      },
      {
        question: "ችግሮችን ለመፍታት ምን ያህል ጊዜ ይወስዳል?",
        answer:
          "የምላሽ ጊዜ በችግሩ ከባድነት ላይ የተመሰረተ ነው። አስቸኳይ ችግሮች ቅድሚያ ያገኛሉ እና በተለምዶ በ24 ሰዓታት ውስጥ ይፈታሉ።",
      },
      {
        question: "የተጠቆሙትን ችግሮች መከታተል እችላለሁ?",
        answer:
          "አዎ፣ ሁሉንም የገቡትን ሪፖርቶች እና ሁኔታቸውን በመገለጫዎ ውስጥ ባለው የሪፖርቶች ክፍል ማየት ትችላለህ።",
      },
      {
        question: "አገልግሎቱ ነፃ ነው?",
        answer:
          "አዎ፣ ሸጋሪፖርት ለደብረ ብርሃን ነዋሪዎች የውሃ እና የንፅህና ችግሮችን ሪፖርት ለማድረግ ሙሉ በሙሉ ነፃ ነው።",
      },
    ],
  };
      ...
      action: () =>
        Alert.alert(
          ...
          language === "en"
            ...
            : "ቀጥታ ውይይት ሰኞ-ዓርብ፣ 8፡00-5፡00 ይገኛል"
        ),
    },
  ];
      ...
      <ScrollView className="flex-1 px-6 py-6">
        ...
        <View className="bg-gray-50 rounded-2xl p-6 ">
          ...
          <TouchableOpacity
            ...
            className={`bg-[#0a5398ff] py-3 rounded-xl ${
